...
% Dieser wird bereits aus dem Briefkopf ersichtlich. Hier wird die signature-Variable einfach auf einen leeren Wert gesetzt und wäre sonst \usekomavar{fromname}.
