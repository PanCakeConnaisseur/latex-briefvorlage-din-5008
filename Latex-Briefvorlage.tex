...
\usepackage{pdfpages}
% klickbare Links und E-Mail-Adressen. Paket url kann keine klickbaren, Paket hyperref kann keine Schriftartänderung, deswegen bookmark
\usepackage{bookmark}
% URLs in derselben Schriftart, wie der Rest, anzeigen
\urlstyle{same}
...
\setkomavar{fromemail}{\href{mailto:anton@absender.de}{\nolinkurl{anton@absender.de}}}
...
\setkomavar{fromurl}[]{\href{http://absender.de}{\nolinkurl{absender.de}}}
